...
class parser_declaration(object):
	...
	def generate_code(self):
		return self.parser_type_declaration.generate_code() + ' ' + self.opt_constructor_parameters.generate_code() + ' {' + self.parser_local_elements.generate_code() + ' ' + self.parser_states.generate_code() + '} '
